...
from .views import (ConsoleHomeList, BrandingInformationCreate,
                    BrandingInformationUpdate, ClientIdentifierCreate,
...
urlpatterns = patterns(
    ...
    url(r'branding/information/add/$',
        BrandingInformationCreate.as_view(),
        name='branding_information_add'),
